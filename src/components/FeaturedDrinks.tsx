...
const drinks = [
  {
    name: "Cappuccino",
    description: "Espresso intens, lapte fin spumat și un echilibru perfect între aromă și textură.",
    image: cappuccino,
  },
  {
    name: "Latte Macchiato",
    description: "Lapte cremos stratificat cu espresso, pentru un gust delicat.",
