const FloatingWhatsApp = () => {
  return (
    ...
    >
      ...
      <span className="absolute -top-1 -right-1 w-4 h-4 bg-caramel rounded-full animate-ping" />
      <span className="absolute -top-1 -right-1 w-4 h-4 bg-caramel rounded-full" />
    </a>
  );
};
