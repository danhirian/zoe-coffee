  ...
  return <div className="min-h-screen flex flex-col bg-background relative">
      ...
      <main className="flex-1 pt-24 pb-16 relative z-10">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <CoffeeBean className="absolute top-40 right-[8%] w-6 h-6 text-caramel/15 -rotate-12 animate-float" style={{ animationDelay: '1s' }} />
          <CoffeeBean className="absolute top-[30%] left-[3%] w-5 h-5 text-cream/20 rotate-90 animate-float" style={{ animationDelay: '2s' }} />
          <CoffeeBean className="absolute top-[45%] right-[5%] w-7 h-7 text-caramel/20 rotate-[30deg] animate-float" style={{ animationDelay: '0.5s' }} />
          <CoffeeBean className="absolute top-[60%] left-[7%] w-6 h-6 text-cream/15 -rotate-45 animate-float" style={{ animationDelay: '1.5s' }} />
          <CoffeeBean className="absolute top-[75%] right-[4%] w-5 h-5 text-caramel/15 rotate-12 animate-float" style={{ animationDelay: '2.5s' }} />
          
          {/* Coffee cups */}
          <Coffee className="absolute top-32 right-[12%] w-10 h-10 text-caramel/15 rotate-12 animate-float" style={{ animationDelay: '0.8s' }} />
          <Coffee className="absolute top-[50%] left-[10%] w-8 h-8 text-cream/20 -rotate-6 animate-float" style={{ animationDelay: '1.8s' }} />
          <Coffee className="absolute top-[85%] right-[10%] w-9 h-9 text-caramel/20 rotate-[-15deg] animate-float" style={{ animationDelay: '3s' }} />
        </div>
